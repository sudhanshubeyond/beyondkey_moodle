define(['jquery', 'core/ajax', 'core/notification'], function($, ajax, notification) {
    var chat = {
	    ...
	    var isWaitingForResponse = false;
            ...
            geniaitextarea
                .keydown(function(e) {
                    ...
                    if (e.key === "Enter" && !e.shiftKey && code == 13) {
	    ...
	    $("#geniai-icon-send").click(function () {
                if (isWaitingForResponse) {
                    return;
                }
                sendMessage();
		...
		if (isWaitingForResponse) {
		    ...
		    isWaitingForResponse = true;
                    geniaitextarea.prop("disabled", true);
                    $("#geniai-icon-send").addClass("disabled");
			...
			isWaitingForResponse = false;
                        geniaitextarea.prop("disabled", false);
                        $("#geniai-icon-send").removeClass("disabled");
