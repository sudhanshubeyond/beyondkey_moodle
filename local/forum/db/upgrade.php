...
function xmldb_local_forum_upgrade($oldversion) {
    ...
    // Check if the plugin is at a version lower than 2025090102
    if ($oldversion < 2025090103) {

        // Define the table and field to be modified
        $table = new xmldb_table('forum');
        $field_teacher_approval = new xmldb_field('teacher_approval', XMLDB_TYPE_INTEGER, '1', null, XMLDB_NOTNULL, null, '1', 'lockdiscussionafter');
        ...
        upgrade_plugin_savepoint(true, 2025090103, 'local', 'forum');
    }
