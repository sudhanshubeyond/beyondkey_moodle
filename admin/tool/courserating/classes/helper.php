...
class helper {
    ...
    public static function get_rating_colour_css() {
        return '.tool_courserating-stars .fa-star { color: ' . self::get_setting(constants::SETTING_STARCOLOR) . '; }' . "\n" .
       '.tool_courserating-stars .fa-star-o { color: ' . constants::COLOR_GRAY . '; }' . "\n" .
    ...
    public static function format_rating_in_course_report($rating, $row): string {
        ...
        return \html_writer::span(
            ...
            \html_writer::span($rating, 'tool_courserating-ratingcolor mx-2'),
