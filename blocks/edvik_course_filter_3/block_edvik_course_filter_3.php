...
global $CFG;
class block_edvik_course_filter_3 extends block_base {
    public function init() {
        $this->title = get_string('pluginname', 'block_edvik_course_filter_3');
    }
    ...
    public function get_content() {
        ...
        $text .= '
        <div class="course-wrap course-wrap position-relative index-1 ptb-100">';
            ...
            <div class="container position-relative index-1">
                ...
                <ul class="nav nav-tabs course-tablist style-two list-unstyle d-flex justify-content-center border-0" role="tablist">';
                                ...
                                foreach ($courses as $course) {
                                    if ($DB->record_exists('course', array('id' => $course->id))) {
                                        ...
                                        <div class="col-xl-4 col-md-6">
                                            <div class="course-card style-three position-relative bg-white round-10 overflow-hidden mb-40">
                                                ...
                                                <div class="course-info-wrap position-relative index-1 transition">
                                                    <div class="course-info bg-spring transition">
                                                        <h3 class="font-medium ls-1"><a href="'. $edvikCourse->url .'">'.$edvikCourse->fullName.'</a></h3>
                                                        <div class="course-instructor-wrap d-flex align-items-center justify-content-between">
                                                            ...
                                                            <div class="course-price"> ';
                                                                if($edvikCourse->course_price) {
                                                                    $text .= '
                                                                    <span class="fs-24 font-semibold text-greenTwo">'.get_config('theme_edvik', 'site_currency') .''.$edvikCourse->course_price.'</span>';
                                                                }else{
                                                                    $text .='
                                                                    <span class="fs-24 font-semibold text-greenTwo">'.get_config('theme_edvik', 'free_course_price') .'</span>';
                                                                }
                                                                $text .= '
                                                            </div>
                                                        </div>
                                                    ...
                                                    if($this->config->course_btn):
                                                        $text .= '
                                                        <a href="'. $edvikCourse->url .'" class="link style-one bg-transparent w-100 d-block text-start font-medium transition">'.format_text($this->config->course_btn, FORMAT_HTML, array('filter' => true)).' <i class="ri-arrow-right-line"></i></a>';
                                                    endif;
                                                    $text .= '
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-xl-4 col-md-6">
                                                    <div class="course-card style-three position-relative bg-white round-10 overflow-hidden mb-40">
                                                        ...
                                                        <div class="course-info-wrap position-relative index-1 transition">
                                                            ...
                                                            if($this->config->course_btn):
                                                                $text .= '
                                                                <a href="'. $edvikCourse->url .'" class="link style-one bg-transparent w-100 d-block text-start font-medium transition">'.$this->config->course_btn.' <i class="ri-arrow-right-line"></i></a>';
                                                            endif;
                                                            $text .= '
                                                        </div>
                                                    </div>
