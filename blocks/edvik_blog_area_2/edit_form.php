...
class block_edvik_blog_area_2_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        $mform->setDefault('config_title', 'Check out our latest News and Blog<img src="'.$CFG->wwwroot.'/theme/edvik/pix/section-title-shape-2.webp" alt="Shape" class="position-absolute bottom-0 end-0">');
        ...
        // Read More text
        $mform->addElement('text', 'config_read_more', 'Read More Text');
        $mform->setDefault('config_read_more', 'Read More');
        $mform->setType('config_read_more', PARAM_RAW);
