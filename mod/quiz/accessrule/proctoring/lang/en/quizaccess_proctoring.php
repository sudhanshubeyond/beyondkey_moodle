...
$string['examdata'] = 'No data is available for this exam session.';
...
$string['notfoundtext'] = 'Not Available';
...
$string['settings:deletesinglesuccess'] = 'Successfully deleted <b>{$a->quizname}</b> record.';
...
$string['settingscontroll:deleteallcourseimage'] = 'Delete all proctoring images and records for this course.';
...
$string['summarypagedesc'] = 'This report summarizes the proctoring records for the course and its quizzes. You can permanently delete all associated images and logs.';
...
$string['userimagenotuploaded'] = 'Student profile image is not available.';
...
$string['webcampicture'] = 'Captured Images';
...
$string['setting:azure_heading_desc'] = 'Configure Azure Blob Storage to automatically upload all proctoring images (webcam snapshots, face images, and admin-uploaded images) to your Azure container. Leave blank to disable Azure upload.';
$string['setting:azure_account_name'] = 'Storage account name';
$string['setting:azure_account_name_desc'] = 'Your Azure Storage account name (e.g. woodmontcollegestorage).';
$string['setting:azure_account_key'] = 'Storage account key';
$string['setting:azure_account_key_desc'] = 'Your Azure Storage account access key. This is stored encrypted. Never hardcode this in PHP files.';
$string['setting:azure_container_name'] = 'Container name';
$string['setting:azure_container_name_desc'] = 'The name of the Azure Blob container to upload images into (e.g. woodmontstoragecontainer).';
