...
if ($hassiteconfig) {
    ...
    $settings->add(new admin_setting_heading(
        ...
        get_string('setting:azure_heading', 'quizaccess_proctoring'),
        get_string('setting:azure_heading_desc', 'quizaccess_proctoring')
    ));

    $settings->add(new admin_setting_configtext(
        'quizaccess_proctoring/azure_account_name',
        get_string('setting:azure_account_name', 'quizaccess_proctoring'),
        get_string('setting:azure_account_name_desc', 'quizaccess_proctoring'),
        '',
        PARAM_TEXT
    ));

    $settings->add(new admin_setting_configpasswordunmask(
        'quizaccess_proctoring/azure_account_key',
        get_string('setting:azure_account_key', 'quizaccess_proctoring'),
        get_string('setting:azure_account_key_desc', 'quizaccess_proctoring'),
        '',
        PARAM_TEXT
    ));

    $settings->add(new admin_setting_configtext(
        'quizaccess_proctoring/azure_container_name',
        get_string('setting:azure_container_name', 'quizaccess_proctoring'),
        get_string('setting:azure_container_name_desc', 'quizaccess_proctoring'),
        '',
        PARAM_TEXT
    ));
